...
class StatsSuite extends munit.FunSuite:
  ...
  test("pearson correlation coefficient") {
    ...
    assertEqualsDouble(v1.pearsonCorrelationCoefficient(v2)(using BoundsChecks.BoundsCheck.yes), 0.529809, 0.0001)
  ...
  test("spearmans rank") {
    ...
    assertEqualsDouble(v1.spearmansRankCorrelation(v2)(using BoundsChecks.BoundsCheck.yes), 0.6727, 0.001)
    ...
    assertEqualsDouble(-0.1757575, v3.spearmansRankCorrelation(v4)(using BoundsChecks.BoundsCheck.yes), 0.000001)
  }
