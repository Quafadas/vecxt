...
// type NArr = NArray {
//   def increments : NArray
//   def of(elem : Double*) : NArray
// }

//type NArray = native.NArray
// object NArray {

//   transparent inline def apply(length: Int): NArray =
//     new vecxt.native.DoubleArray(length)
...
// opaque type vecxt1 = vecxt {
//   def increments : vecxt
// }
...
//inline def incrementsX : vexct = vecxt.increments.asInstanceOf[vexct]
