...
class BooleanArrayExtensionSuite extends munit.FunSuite:
  ...
  test("not - small array") {
    val v1 = NArray[Boolean](true, false, true, false)
    val result = v1.not
  ...
  test("not - large array (tests SIMD path)") {
    ...
    val size = 1025
    val v1 = NArray.fill[Boolean](size)(true)
  ...
  test("not - all true") {
    val v1 = NArray.fill[Boolean](100)(true)
    val result = v1.not
  ...
  test("not - all false") {
    val v1 = NArray.fill[Boolean](100)(false)
    val result = v1.not
  ...
  test("not and not! equivalence") {
    val size = 500
    val v1 = NArray.tabulate[Boolean](size)(i => i % 3 == 0)
    val v2 = NArray.tabulate[Boolean](size)(i => i % 3 == 0)
