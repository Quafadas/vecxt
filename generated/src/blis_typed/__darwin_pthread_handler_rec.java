...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        blis_h.C_POINTER.withName("__routine"),
        blis_h.C_POINTER.withName("__arg"),
        blis_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = blis_h.upcallHandle(__routine.Function.class, "apply", $DESC);
