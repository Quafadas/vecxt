...
public class mbool_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(4, blis_h.C_BOOL).withName("v")
    ).withName("mbool_s");
     ...
     * }
     */
    public static boolean v(MemorySegment struct, long index0) {
        return (boolean)v$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void v(MemorySegment struct, long index0, boolean fieldValue) {
