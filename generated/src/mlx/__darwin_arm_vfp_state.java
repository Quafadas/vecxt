...
public class __darwin_arm_vfp_state {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(64, mlx_h.C_INT).withName("__r"),
        mlx_h.C_INT.withName("__fpscr")
    ...
    private static final long __fpscr$OFFSET = $LAYOUT.byteOffset(groupElement("__fpscr"));
