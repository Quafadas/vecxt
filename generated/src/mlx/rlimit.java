...
public class rlimit {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        mlx_h.C_LONG_LONG.withName("rlim_cur"),
        mlx_h.C_LONG_LONG.withName("rlim_max")
    ).withName("rlimit");
    ...
    private static final long rlim_cur$OFFSET = $LAYOUT.byteOffset(groupElement("rlim_cur"));
    ...
    private static final long rlim_max$OFFSET = $LAYOUT.byteOffset(groupElement("rlim_max"));
