...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        mlx_h.C_POINTER.withName("__routine"),
        mlx_h.C_POINTER.withName("__arg"),
        mlx_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = mlx_h.upcallHandle(__routine.Function.class, "apply", $DESC);
