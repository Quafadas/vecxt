...
public class __sigaction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        mlx_h.C_POINTER.withName("sa_tramp"),
        mlx_h.C_INT.withName("sa_mask"),
        mlx_h.C_INT.withName("sa_flags")
    ...
    private static final long __sigaction_u$OFFSET = $LAYOUT.byteOffset(groupElement("__sigaction_u"));
     ...
     * }
     */
    public final static class sa_tramp {
        ...
        private static final MethodHandle UP$MH = mlx_h.upcallHandle(sa_tramp.Function.class, "apply", $DESC);
    ...
    private static final long sa_tramp$OFFSET = $LAYOUT.byteOffset(groupElement("sa_tramp"));
