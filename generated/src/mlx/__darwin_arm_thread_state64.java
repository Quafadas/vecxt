...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, mlx_h.C_LONG_LONG).withName("__x"),
        mlx_h.C_LONG_LONG.withName("__fp"),
        mlx_h.C_LONG_LONG.withName("__lr"),
        mlx_h.C_LONG_LONG.withName("__sp"),
        mlx_h.C_LONG_LONG.withName("__pc"),
        mlx_h.C_INT.withName("__cpsr"),
        mlx_h.C_INT.withName("__pad")
    ...
    private static final long __fp$OFFSET = $LAYOUT.byteOffset(groupElement("__fp"));
