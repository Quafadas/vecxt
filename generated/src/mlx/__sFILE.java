...
public class __sFILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        mlx_h.C_POINTER.withName("_p"),
        mlx_h.C_INT.withName("_r"),
        mlx_h.C_INT.withName("_w"),
        mlx_h.C_SHORT.withName("_flags"),
        mlx_h.C_SHORT.withName("_file"),
        MemoryLayout.paddingLayout(4),
        __sbuf.layout().withName("_bf"),
        mlx_h.C_INT.withName("_lbfsize"),
        MemoryLayout.paddingLayout(4),
        mlx_h.C_POINTER.withName("_cookie"),
        mlx_h.C_POINTER.withName("_close"),
        mlx_h.C_POINTER.withName("_read"),
        mlx_h.C_POINTER.withName("_seek"),
        mlx_h.C_POINTER.withName("_write"),
        __sbuf.layout().withName("_ub"),
        mlx_h.C_POINTER.withName("_extra"),
        mlx_h.C_INT.withName("_ur"),
        MemoryLayout.sequenceLayout(3, mlx_h.C_CHAR).withName("_ubuf"),
        MemoryLayout.sequenceLayout(1, mlx_h.C_CHAR).withName("_nbuf"),
        __sbuf.layout().withName("_lb"),
        mlx_h.C_INT.withName("_blksize"),
        MemoryLayout.paddingLayout(4),
        mlx_h.C_LONG_LONG.withName("_offset")
    ).withName("__sFILE");
    ...
    private static final long _p$OFFSET = $LAYOUT.byteOffset(groupElement("_p"));
    ...
    private static final long _r$OFFSET = $LAYOUT.byteOffset(groupElement("_r"));
    ...
    private static final long _w$OFFSET = $LAYOUT.byteOffset(groupElement("_w"));
    ...
    private static final long _file$OFFSET = $LAYOUT.byteOffset(groupElement("_file"));
    ...
    private static final long _bf$OFFSET = $LAYOUT.byteOffset(groupElement("_bf"));
    ...
    private static final long _lbfsize$OFFSET = $LAYOUT.byteOffset(groupElement("_lbfsize"));
    ...
    private static final long _cookie$OFFSET = $LAYOUT.byteOffset(groupElement("_cookie"));
     ...
     * }
     */
    public final static class _close {
        ...
        private static final MethodHandle UP$MH = mlx_h.upcallHandle(_close.Function.class, "apply", $DESC);
    ...
    private static final long _close$OFFSET = $LAYOUT.byteOffset(groupElement("_close"));
     ...
     * }
     */
    public final static class _read {
        ...
        private static final MethodHandle UP$MH = mlx_h.upcallHandle(_read.Function.class, "apply", $DESC);
    ...
    private static final long _read$OFFSET = $LAYOUT.byteOffset(groupElement("_read"));
     ...
     * }
     */
    public final static class _seek {
        ...
        private static final MethodHandle UP$MH = mlx_h.upcallHandle(_seek.Function.class, "apply", $DESC);
    ...
    private static final long _seek$OFFSET = $LAYOUT.byteOffset(groupElement("_seek"));
     ...
     * }
     */
    public final static class _write {
        ...
        private static final MethodHandle UP$MH = mlx_h.upcallHandle(_write.Function.class, "apply", $DESC);
    ...
    private static final long _write$OFFSET = $LAYOUT.byteOffset(groupElement("_write"));
    ...
    private static final long _ub$OFFSET = $LAYOUT.byteOffset(groupElement("_ub"));
    ...
    private static final long _extra$OFFSET = $LAYOUT.byteOffset(groupElement("_extra"));
    ...
    private static final long _ur$OFFSET = $LAYOUT.byteOffset(groupElement("_ur"));
    ...
    private static final long _ubuf$OFFSET = $LAYOUT.byteOffset(groupElement("_ubuf"));
    ...
    private static final long _nbuf$OFFSET = $LAYOUT.byteOffset(groupElement("_nbuf"));
    ...
    private static final long _lb$OFFSET = $LAYOUT.byteOffset(groupElement("_lb"));
    ...
    private static final long _blksize$OFFSET = $LAYOUT.byteOffset(groupElement("_blksize"));
